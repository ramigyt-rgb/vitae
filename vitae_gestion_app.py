...
def render_dashboard() -> None:
    ...
    cuenta_corriente_vmr = total_mod("Cuenta Corriente VMR")
    cuenta_corriente_vm = total_mod("Cuenta Corriente VM")
    c1, c2, c3, c4, c5 = st.columns(5)
    ...
    c11.metric(
        "Cuenta Corriente VMR",
        fmt_money(total_mod("Cuenta Corriente VMR")
    )
    c12.metric(
        "Cuenta Corriente VMR",
        fmt_money(total_mod()"Cuenta Corriente VM")
    )
    st.divider()
