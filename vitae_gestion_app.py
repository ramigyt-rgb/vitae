        ...
        if df.empty:
            ...
            if guardar:   
                ...
                try:
                    ...
                    limpio = limpio.drop(columns=["saldo", "saldo_usd"], errors="ignore")
                    st.write("FILAS A GUARDAR:", len(limpio))
                    st.write(limpio)
                    st.error("Guardar cambios masivos está desactivado para evitar borrar datos. Usá carga individual o importación controlada")
                    st.stop()
