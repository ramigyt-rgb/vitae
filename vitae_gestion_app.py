...
o1.metric("Pacientes / procedimientos del mes", 0)
o2.metric("Médicos activos del mes", 0)
o3.metric("Pendiente neto de cobro", 0)
st.divider()
...
errors="coerce")
        ...
        temp = temp[temp["vencimiento_dt"] >= pd.Timestamp.today().normalize]
